...
{$this->Form->create('Word')}
    ...
    <div>
        {$this->Form->hidden('WordAnswer.0.id')}
        <div class="col-sm-9">
    ...
    <div>
        {$this->Form->hidden('WordAnswer.1.id')}
         <div class="col-sm-9">
    ...
    <div>
        {$this->Form->hidden('WordAnswer.2.id')}
         <div class="col-sm-9">
    ...
    <div>
        {$this->Form->hidden('WordAnswer.3.id')}
         <div class="col-sm-9">
